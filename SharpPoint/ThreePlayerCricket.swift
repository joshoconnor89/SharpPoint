...
//Controls three player Cricket.


import UIKit

class ThreePlayerCricket: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var tableData: [String] = ["cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png", "cricket1.png"]

    //Outlets.
    @IBOutlet weak var logo3: UIImageView!
    @IBOutlet weak var gametype3: UILabel!
    @IBOutlet weak var AddDelete3: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        AddDelete3.image = UIImage(named: "plus.png")
        
        //Add gesture recognizer to image.
        tap.addTarget(self, action: "tappedView")
        AddDelete3.userInteractionEnabled = true
        AddDelete3.addGestureRecognizer(tap)
    ...
    func tappedView() {
        ...
        if AddDelete3.image == UIImage(named: "plus.png") {
            AddDelete3.image = UIImage (named: "minus.png")
        }
        else {
            AddDelete3.image = UIImage(named: "plus.png")
        }
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell: CricketCell3 = collectionView.dequeueReusableCellWithReuseIdentifier("Cell3", forIndexPath: indexPath) as! CricketCell3
        cell.imgCell3.image = UIImage(named: tableData[indexPath.row])
        return cell
    }
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        ...
        var cell = collectionView.cellForItemAtIndexPath(indexPath) as! CricketCell3
        ...
        if AddDelete3.image == UIImage(named: "plus.png") {
            ...
            if self.tableData[index] == firstImage  {
                ...
                cell.imgCell3.image = UIImage(named: secondImage)
                println(tableData)
                ...
                cell.imgCell3.image = UIImage(named: thirdImage)
                println(tableData)
                ...
                cell.imgCell3.image = UIImage(named: fourthImage)
                println(tableData)
        ...
        //If the image is a minus (subtracting from scoreboard).
            ...
            if self.tableData[index] == fourthImage  {
                ...
                cell.imgCell3.image = UIImage(named: firstImage)
                println(tableData)
    ...
    //When game is saved.
    @IBAction func savegame3(sender: AnyObject) {
        ...
        let contactDB = FMDatabase(path:databasePath as String)
        if  contactDB.open() {
            let insertSql = "Insert into GAME (PLAYERS, GAMETYPE, TABLEDATA, TIME) VALUES ('\(logo3.tag)','\(gametype3.text!)','\(tableStuff)','\(gameTime)')"
